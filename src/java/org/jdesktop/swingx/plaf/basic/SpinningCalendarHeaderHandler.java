...
/**
 * Custom CalendarHeaderHandler which supports year-wise navigation.<p>
 * 
 * 
...
//----------------- public/protected overrides to manage custom creation/config
...
//----------------  listening/update triggered by changes of the JXMonthView   
    ...
    /**
     * Returns the property change listener for use on the monthView. This
     * is lazyly created if not yet done. This implementation listens to
     * changes of firstDisplayedDay and locale property and updates internal
     * state accordingly.
     * 
...
//---------------------- methods to back to Spinner model
    ...
    /**
     * Returns the previous year of the monthView. Callback for spinner model.<p>
     * 
    ...
    /**
     * Returns the next year of the monthView. Callback for spinner model.<p>
     * 
    ...
    /**
     * Thin-layer implementation of a SpinnerModel which is actually 
     * backed by this controller.
     */
    ...
    protected static class SpinningCalendarHeader extends JXPanel {
        ...
        public void setArrowsSurroundMonth(boolean surroundMonth) {
            if (this.surroundMonth == surroundMonth) return;
