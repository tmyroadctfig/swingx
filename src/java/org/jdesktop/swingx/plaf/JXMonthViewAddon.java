...
public class JXMonthViewAddon extends AbstractComponentAddon {
    ...
    protected void addBasicDefaults(LookAndFeelAddons addon, List<Object> defaults) {
        ...
        defaults.addAll(Arrays.asList(new Object[] {
                ...
                "JXMonthView.background", ColorUIResource.WHITE,
                ...
                "JXMonthView.flaggedDayForeground", ColorUIResource.RED,
                "JXMonthView.leadingDayForeground", ColorUIResource.LIGHT_GRAY,
                "JXMonthView.trailingDayForeground", ColorUIResource.LIGHT_GRAY,
