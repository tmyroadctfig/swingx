...
/**
 * A helper class which is an implementation of a message source and a
 * progress source.
 * This class manages the listener list and has convenience methods
 * to fire MessageEvents and ProgressEvents.
 *
 * @see MessageEvent
 * @see MessageSource
 * @see ProgressEvent
 ...
 */
public class MessageSourceSupport implements MessageSource,
                         ProgressSource {
    ...
    /**
     * Creates an MessageSource instance using the source object
