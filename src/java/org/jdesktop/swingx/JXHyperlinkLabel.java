 ...
 * JXHyperlinkLabel.clickedColor and JXHyperlinkLabel.unclickedColor.
 *
 * @deprecated this is the original "JXHyperlink" (as label) was replaced
 *   by JXHyperlink (as button). will be removed soon.
 *
 * @author Richard Bair
 */
public class JXHyperlinkLabel extends JLabel {
	/**
	 * Color for the hyper link if it has not yet been clicked.
	 * This color can be set both in code, and through the UIManager
	 * with the property "JXHyperlinkLabel.unclickedColor".
	 */
	private Color unclickedColor = new Color(0, 0x33, 0xFF);
	/**
	 * Color for the hyper link if it has already been clicked.
	 * This color can be set both in code, and through the UIManager
	 * with the property "JXHyperlinkLabel.clickedColor".
	 */
    ...
    /**
     * The Action, if any, associated with this JXHyperlinkLabel. It is possible for there
     * to be more than one ActionListener associated with this JXHyperlinkLabel. It is also
     * possible for the text & icon of the JXHyperlinkLabel to be set independently of this
	 ...
	 * @param clickListener
	 */
	public JXHyperlinkLabel(String text, ActionListener clickListener) {
	 ...
	 * @param clickListener
	 */
	public JXHyperlinkLabel(ActionListener clickListener) {
		super();
	 ...
	 * @param clickListener
	 */
	public JXHyperlinkLabel(String text, int horizontalAlignment, ActionListener clickListener) {
		super();
		setOpaque(false);
		setText(text);
	...
	/**
	 * Create a new JXHyperlinkLabel based on the given action.  The click event
	 * handler is the action's handler, and so forth.
	 * @param a
	 */
	public JXHyperlinkLabel(Action a) {
		this();
        setAction(a);
	}
	...
	/**
	 * Method for changing the action associated with this JXHyperlinkLabel.
	 * @param action
	 */
	...
	private static final class HyperlinkMouseListener extends MouseAdapter {
		/**
		 * the parent JXHyperlinkLabel component
		 */
		private JXHyperlinkLabel parent;
		private Cursor oldCursor = null;
		
		private HyperlinkMouseListener(JXHyperlinkLabel parent) {
			assert parent != null;
			this.parent = parent;
		}
